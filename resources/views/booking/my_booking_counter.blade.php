                ...
                <div class="x_panel" style="position:sticky !important">
                    ...
                    <div class="x_content" style="position:sticky !important">
                        ...
                        <form class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="col-md-6 col-sm-3 col-xs-12" style="">Agent Name</label>
                                <div class="col-md-6 col-sm-9 col-xs-12">      
                                    <span style="color: white;background-color:#1D441F;padding:3px;border-radius:2px">{{ucwords($user->name)}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                           ...
                           @if (count($dewasa) == 1)
                            ...
                            <div class="form-group">
                                <label class="col-md-6 col-sm-3 col-xs-12" style="">Agent Paid</label>
                                <div class="col-md-6 col-sm-9 col-xs-12">      
                                    <span style="color: red">- Rp {{number_format($booking->paid)}} </span>
                                </div>
                            </div>
                            <div class="ln_solid"></div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-12">      
                                    <span style="background-color:#1D441F; color:white ;padding:5px;border-radius:5px;font-size:16px">Rp {{number_format($tot - ((count($dewasa) + count($cwb) + count($cwob)) * $jadwal->commission) - $booking->paid)}} </span>
                                    
                                </div>
                            </div>
                        </form>
                        <form class="form-horizontal form-label-left fow" action="{{url('my-booking/payment-counter')}}" method="post">
                            @csrf
                            
                            <div class="form-group">
                                <label for="middle-name" class="col-md-6 col-sm-3 col-xs-12" >Input Your Deposit Nominal</label>
                                <div class="col-md-6 col-sm-9 col-xs-12">
                                    <input  class="form-control col-md-3 col-xs-12" type="hidden" name="book" value="{{$booking->id}}">
                                    <input id="input1" class="form-control col-md-12 col-xs-12" type="number" name="deposit" required>
                                    <div id="error-message-1" style="color: white; background: red"></div>
                                </div>
                            </div>
                            <input type="hidden" id="last-name" name="total" required="required" class="form-control col-md-7 col-xs-12" value="{{($tot - ((count($dewasa) + count($cwb) + count($cwob)) * $jadwal->commission) - $booking->paid)}}">
                            <div class="form-group">
                                <div class="col-md-3 col-md-offset-6">
                                    <button id="send" type="submit" class="btn btn-success" onclick="return confirm('Attention : This action can not be undone, are you sure you want to continue?')">Continue to Payment</button>
                                </div>
                            </div>
